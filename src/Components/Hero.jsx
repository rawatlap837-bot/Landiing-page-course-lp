      ...
      <div className="relative mx-auto max-w-6xl px-4 pt-12 pb-10 text-center sm:px-6 sm:pt-12 sm:pb-14">
        ...
        >
          <div className="group relative overflow-hidden rounded-2xl border border-violet-400/20 bg-slate-950 shadow-xl shadow-violet-950/60 transition-shadow duration-500 hover:shadow-2xl hover:shadow-violet-900/70 sm:rounded-3xl sm:shadow-2xl">
            ...
            <div className="absolute bottom-2 left-2 flex max-w-[85%] items-center gap-2 rounded-full bg-slate-900/90 py-1.5 pl-1.5 pr-3 shadow-lg backdrop-blur sm:bottom-5 sm:left-5 sm:max-w-[90%] sm:gap-3 sm:py-2 sm:pl-2 sm:pr-4">
              <span
                className="hero-play-badge flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-violet-500 text-white sm:h-8 sm:w-8"
                style={{ animation: "playPulse 2.4s ease-out infinite" }}
              >
                <Play className="h-2.5 w-2.5 fill-current sm:h-3.5 sm:w-3.5" />
              </span>
              <span className="truncate text-[10px] font-semibold text-slate-100 sm:text-xs">
